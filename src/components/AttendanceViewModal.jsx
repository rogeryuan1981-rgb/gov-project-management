...
// 🎯 核心整併：統一只引用 AttendanceViewModal 作為全局考勤與異常判定的唯一核心檔案
...
export default function AttendanceModule({ user, selectedProject }) {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 max-w-6xl mx-auto">
      ...
      {/* 🎯 母面板控制一體化：依據使用者選取的面板按鈕，傳遞對應的檢視狀態並開啟同一個判斷組件大視窗 */}
      ...
      {/* 🎯 子元件通訊整併：統一由大總覽視窗接管，將 dynamicUnits 與點選按鈕產生的 initialMode 灌入 */}
      <AttendanceViewModal 
